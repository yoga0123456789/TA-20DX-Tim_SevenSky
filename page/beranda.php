...
<div id="box">
  ...
  foreach ($data as $value) { ?>
    <td class="list">
      <img src="img/laptop/<?php echo $value['nama_image']; ?>" width="100">
    <br><?php echo $value['deskripsi']; ?>
    <br><b><?php echo "Rp.".$value['harga']; ?></b> <br>
    <br>
    <?php
    ...
    if ($sisa > 0){
    if (isset ($_SESSION['username']) != ""){ ?>
      <a class="tombol-biru" href="?page=belanja_detail&id=<?php echo $value['id_barang']; ?>&st=<?php echo $sisa; ?>">Beli</a>
